...
namespace VSTODATN
{
    public partial class Ribbon
    {
        ...
        private void SpeedText_Click(object sender, RibbonControlEventArgs e)
        {
        ...
        private void Exchange_Click(object sender, RibbonControlEventArgs e)
        {
        ...
        private void ReadNumber_Click(object sender, RibbonControlEventArgs e)
        {
            Excel.Worksheet activeWorksheet = Globals.ThisAddIn.Application.ActiveSheet;
            Excel.Range actCell = Globals.ThisAddIn.Application.ActiveCell;
        ...
        private void ExportJson_Click(object sender, RibbonControlEventArgs e)
        {
            ...
            VSTODATN.FunctionsExcel.ExportJson.ExportExcelToJson(excellApp);
        }

        private void ImportJson_Click(object sender, RibbonControlEventArgs e)
        {
            Excel.Application excellApp = Globals.ThisAddIn.Application;
            VSTODATN.FunctionsExcel.ImportJson.ImportJsonToExcel(excellApp);
        }

        private void ExportJsonFormat_Click(object sender, RibbonControlEventArgs e)
        {
            Excel.Application excellApp = Globals.ThisAddIn.Application;
            VSTODATN.FunctionsExcel.ExportJson.ExportExcelToJsonFormat(excellApp);
        }

        private void Instruction_Click(object sender, RibbonControlEventArgs e)
        {
